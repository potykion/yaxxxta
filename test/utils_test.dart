...
void main() {
  test("Форматирование дюрейшена", () {
    expect(Duration(hours: 1, minutes: 2, seconds: 3).format(), "1:02:03");
    expect(Duration(hours: 1).format(), "1:00:00");
    expect(Duration(minutes: 1).format(), "1:00");
    expect(Duration(seconds: 1).format(), "1");
  });
